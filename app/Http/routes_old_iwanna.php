...
// Route::get('promocion/{id_promocion}', ['uses' => 'UsuarioServiciosController@getPromociones', 'as' => 'getPromocion', 'middleware' => 'notAuth']);

// Route::get('eventos/{id}', ['uses' => 'UsuarioServiciosController@getEventos', 'as' => 'getEventos', 'middleware' => 'notAuth']);

// Route::get('itinerario/{id}', ['uses' => 'UsuarioServiciosController@getItinerarios', 'as' => 'getItinerarios', 'middleware' => 'notAuth']);
...
// Route::get('/getSearchCatalogosServiciosIntern/{id}/{id_catalogo}/{ciudad}', ['as' => 'SearchcatalogoServicios', 'uses' => 'HomePublicController@getCatalosoServiciosSearchIntern']);
...
// Route::post('especialidad', ['as' => 'postEspecialidad', 'uses' => 'UsuarioServiciosController@postEspecialidad', 'middleware' => 'notAuth']);

// Route::get('especialidad/{id}', ['uses' => 'UsuarioServiciosController@getEspecialidad', 'as' => 'getEspecialidad', 'middleware' => 'notAuth']);
...
// Route::post('estadoEspecialidadPrincipal/{id}', ['uses' => 'UsuarioServiciosController@postEstadoEspecialidad', 'middleware' => 'notAuth']);

// Route::post('estadoBookingPrincipal/{id}', ['uses' => 'UsuarioServiciosController@postEstadoBooking', 'middleware' => 'notAuth']);
...
// Route::get('dashboard', ['uses' => 'UsuarioServiciosController@getServiciosOperadorRes', 'as' => 'dashboard', 'middleware' => 'notAuth']);
