...
</style><link type="text/css" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,700,400"><!--<![endif]--><style type="text/css">
...
<meta content="iWaNaTrip" property="og:title">
<link type="text/css" rel="stylesheet" media="screen,projection" href="https://css.createsend1.com/css/social.min.css?h=0ED47CE1Lions">
...
<![endif]-->
<!--[if !mso]><!-->
  <body style="margin: 0;padding: 0;min-width: 100%;background-color: #f5f7fa;" class="full-padding">
<!--<![endif]-->
    <center style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f5f7fa;" class="wrapper">
     
      
          <table width="602" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #dddee1;Margin-left: auto;Margin-right: auto;" class="border">
          ...
          <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;" class="centered">
            <tbody><tr>
              ...
              <td style="padding: 0;vertical-align: top;">
                <table emb-background-style="" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 600px;background-color: #ffffff;table-layout: fixed;" class="one-col">
                  <tbody><tr>
                    <td style="padding: 0;vertical-align: top;text-align: left;" class="column">
            ...
            <h2 style="font-style: normal;font-weight: 700;Margin-bottom: 0;Margin-top: 0;font-size: 24px;line-height: 32px;font-family: &quot;Open Sans&quot;,sans-serif;color: #f05a22;text-align: center;">Recuperación de contraseña</h2><p style="font-style: normal;font-weight: 400;Margin-bottom: 24px;Margin-top: 16px;font-size: 15px;line-height: 24px;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;text-align: center;">Para recuperar su contraseña ingrese al siguiente link . {!! link_to('/viewRestorePassword/' . $restore_code, $link) !!}</p>
            ...
            <div align="center" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: &quot;Open Sans&quot;,sans-serif;color: #60666d;" class="image">
              <a href="https://iwanatrip.com/ServiciosOperadores" style="transition: opacity 0.2s ease-in;color: #5c91ad;" target="_blank"><img width="600" height="293" alt="iWaNaTrip" src='https://iwanatrip.com/public/img/back.jpg' style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;"></a>
            </div>
      ...
      <table style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 100%;" class="footer centered">
        <tbody><tr>
          <td style="padding: 0;vertical-align: top;">&nbsp;</td>
          <td style="padding: 58px 0 29px 0;vertical-align: top;width: 600px;" class="inner">
            <table align="right" style="border-collapse: collapse;border-spacing: 0;" class="right">
              <tbody><tr>
                <td style="padding: 0;vertical-align: top;color: #b9b9b9;font-size: 12px;line-height: 22px;max-width: 200px;mso-line-height-rule: at-least;">
                  <div class="sharing">
                    ...
                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://igt.createsend1.com/t/i-tw-ijfjkl-l-t/" style="width:85px" arcsize="8%" fill="t" stroke="f"><v:fill type="tile" src="https://i4.createsend1.com/static/eb/master/03-fresh/imgf/tweet.png" color="#7B7C7D"></v:fill><v:textbox style="mso-fit-shape-to-text:t" inset="27px,7px,0,6px"><p style="font-size:11px;line-height:11px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:-1px">                        Tweet                      </p></v:textbox></v:roundrect><![endif]--></div>
                    
                    <div style="Margin-bottom: 5px;">
                      <!--[if !mso]--><a left-align-text="true" href="https://www.facebook.com/IWannaTrip-1631331070450595/?ref=br_tf" style="font-family: &quot;Open Sans&quot;,sans-serif;transition: opacity 0.2s ease-in;color: #ffffff;background-image: url(https://i6.createsend1.com/static/eb/master/03-fresh/imgf/forward.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;display: block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7b7c7d;" class="forwardtoafriend" target="_blank">
                        Like
                      </a><!--[endif]-->
                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://igt.forwardtomyfriend.com/i-l-2AD73FFF-ijfjkl-l-i" style="width:85px" arcsize="8%" fill="t" stroke="f"><v:fill type="tile" src="https://i6.createsend1.com/static/eb/master/03-fresh/imgf/forward.png" color="#7B7C7D"></v:fill><v:textbox style="mso-fit-shape-to-text:t" inset="27px,7px,0,6px"><p style="font-size:11px;line-height:11px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:-1px">                        Forward                      </p></v:textbox></v:roundrect><![endif]--></div>
                  </div>
                </td>
              </tr>
            </tbody></table>
            <table align="left" style="border-collapse: collapse;border-spacing: 0;" class="left">
              <tbody><tr>
                <td style="padding: 0;vertical-align: top;color: #b9b9b9;font-size: 12px;line-height: 22px;text-align: left;width: 400px;">
                  <div style="line-height: 26px;Margin-bottom: 26px;mso-line-height-rule: at-least;" class="links emb-web-links">
                  ...
                  <div style="font-family: &quot;Open Sans&quot;,sans-serif;Margin-bottom: 18px;" class="campaign">
                    <span>
                      <a lang="en" href="http://igt.updatemyprofile.com/i-l-2AD73FFF-l-b" style="transition: opacity 0.2s ease-in;color: #b9b9b9;font-weight: bold;text-decoration: none;" target="_blank">Preferences</a>
                      &nbsp;&nbsp;|&nbsp;&nbsp;
                    </span>
                    <a href="http://igt.createsend1.com/t/i-u-ijfjkl-l-n/" style="transition: opacity 0.2s ease-in;color: #b9b9b9;font-weight: bold;text-decoration: none;" target="_blank">Unsubscribe</a>
                  </div>
                </td>
              </tr>
            </tbody></table>
  ...
  <img width="1" height="1" border="0" alt="" src="https://igt.createsend1.com/t/i-o-ijfjkl-l/o.gif" style="border: 0 !important;-ms-interpolation-mode: bicubic;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;margin: 0 !important;padding: 0 !important;">
<script src="https://js.createsend1.com/js/jquery-1.7.2.min.js?h=C99A4659Lions" type="text/javascript"></script>
<div id="fb-root" class=" fb_reset"><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div></div></div><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div><iframe frameborder="0" name="fb_xdm_frame_https" allowtransparency="true" allowfullscreen="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" style="border: medium none;" src="https://s-static.ak.facebook.com/connect/xd_arbiter/TlA_zCeMkxl.js?version=41#channel=f14d22dd6af6ce8&amp;origin=https%3A%2F%2Figt3-closed.createsend.com"></iframe></div></div></div>
<script src="https://connect.facebook.net/en_US/all.js#xfbml=1"></script>

<script src="https://js.createsend1.com/js/track.min.js?h=B7B39702Lions" type="text/javascript"></script>
<script type="text/javascript">
$(document).ready(function () {
    CS.WebVersion.setup({"LikeActionBase":"/t/i-fb-ijfjkl-l-","IsSubscriber":false});
});
</script>
<script type="text/javascript">$(function(){$('area,a').attr('target', '_blank');});</script>
    <div style="display:none;" id="facebox">       <div class="popup">         <div class="content">         </div>         <div id="closeBox">           <a class="close" href="#" target="_blank">Close</a>         </div>       </div>     </div></body></html>