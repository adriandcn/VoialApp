                ...
                <div class="container">
                    @if(session('device')=='mobile')
                      <div class="heading-box">
                          <br/>
                        <br/>
                       <!-- <p class="desc-lg">Siempre recuerda que <em class="skin-color">la vida es un viaje</em> no un destino, date tiempo para viajar</p>-->
                        <p class="desc-lg"> </p>
                        <h2 class="box-title"><em style="color:#378F91"><b>iWaNaTrip</b> </em></h2>
                        <p class=""><em class="skin-color">Deja de ser turista y conviertete en viajero</em></p>
                        <p class="">Te ayudaremos a encontrar los mejores lugares y aventuras para que tu viaje sea inolvidable.Viaja por el mundo y descubre Ecuador</p>
                        
                        
                           <!--         <p class="desc-lg">Llena tu vida de los mejores momentos y experiencias. </p>
                                    <p class="desc-lg">Bienvenidos al buscador viajero más grande del Ecuador</p>-->
