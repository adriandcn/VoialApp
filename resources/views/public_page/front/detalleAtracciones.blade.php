...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        ...
        {!! HTML::style('public_components/components/owl-carousel/owl.transitions.css') !!} 
           ...
           {!! HTML::style('public_components/css/bootstrap.min.css') !!} 
        {!! HTML::style('public_components/css/bootstrap-theme.min.css') !!} 
                                ...
                                <div class="product-images col-sm-5 box-lg  ">
                                    <div id="sync1" class="owl-carousel images">
                                        <div class="post-slider style3 owl-carousel box">
                                            ...
                                            @if($profile!=null)
                                            <?php $header= asset('public/images/fullsize/'.$profile->filename)?>
                                            <a href="{{ asset('public/images/fullsize/'.$profile->filename)}}" class="soap-mfp-popup">
                                            ...
                                            @else
                                            <?php $header= asset('public/images/fullsize/'.$imagenes[0]->filename)?>
                                             <a href="{{ asset('public/images/fullsize/'.$imagenes[0]->filename)}}" class="soap-mfp-popup">
                                    ...
                                    <div id="sync2" class="owl-carousel post-slider style3 thumbnails" data-items="4">
                                         ...
                                         @foreach ($imagenes as $imagen)
                                          ...
                                          <div class="item">
                                            <a href="{{ asset('public/images/fullsize/'.$imagen->filename)}}" class="soap-mfp-popup"><img src="{{ asset('images/icon/'.$imagen->filename)}}" alt="{!!$atraccion->nombre_servicio!!}"></a>
 ...
 <div class="main-mini-search-form full-width box">
                        ...
                        <div class="widget box">
                            ...
                            <ul class="product-list-widget">
                                ...
                                @foreach ($servicios as $serv)
                                   @if($serv->id_catalogo_servicios!=3 && $serv->id_catalogo_servicios!=4 )
                                <li>
                                    <div class="product-image">
                                        <a href="{!!asset('/tokenDc$ripT')!!}/{!!$atraccion->id!!}/{!!$serv->id_catalogo_servicios!!}"  onclick="$('.container').LoadingOverlay('show');">
							...
							<div class="col-xs-12">
								<ul class="demo1">
									...
									<li class="news-item">
										<table cellpadding="4">
											<tr>
												<td>    <a href="{!!asset('/detalle')!!}/Montañita/148">
                                            <img src="{{ asset('images/icon/148103677257361922164010645062755965301191111n.jpg')}}" width="60" class="img-square" alt="Montañita">
                                        </a></td>
												<td> <div class="product-content">
                                        <h6 class="product-title"><a href="{!!asset('/detalle')!!}/Montañita/148">Montañita</a></h6>
                                           
                                    </div> <a href="#">Read more...</a></td>
											</tr>
										</table>
									</li>
									<li class="news-item">
...
<script type="text/javascript" src="{{ asset('public_components/js/jquery.bootstrap.newsbox.min.js')}}"></script>
  
<script type="text/javascript" src="{{ asset('public_components/js/jquery.bootstrap.newsbox.js')}}"></script>
