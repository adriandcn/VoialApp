                    ...
                    <div class="section-info">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <h4>{{trans('front/loginres.ingresocuenta')}}</h4>
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! link_to('password/email', trans('front/loginres.forget'),array('class' => 'logininput')) !!}
                                    </div>
                                    <div class="form-group">
                         ...
                         <br>  
                            ...
                            <div class="col-sm-6">
                                <br>
                                  <img src="http://ecuatorianoenvivo.com/wp-content/uploads/2015/07/Turismo-en-Ecuador-.jpg" alt="" class="pull-left" style="padding-right: 2%; padding-bottom: 2%;">
                                        <p>iWaNaTrip te conecta directamente con turistas en todo el mundo.</p>
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                               <img src="http://www.elciudadano.gob.ec/wp-content/uploads/2015/01/turismo-ecuador-680x365.jpg" alt="" class="pull-left" style="padding-right: 2%; padding-bottom: 2%;">
                                        <p>Estas listo para promocionarte en iWaNaTrip.com?.</p>
