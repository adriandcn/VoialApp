...
<body>
    ...
    <div class="text-center text-sm-left page">
      ...
      ?>
                    ...
                    <div class="shell">
                        <div class="range range-50">
                            <div class="cell-md-3">
                              ...
                              <br>
                              <hr>
                              <div id="spinnerLoadImagesAdmin" style="color: #c26933;">
                                <i class="fa fa-spinner fa-spin"></i> Cargando imagenes ...
                              </div>
                            ...
                            <div class="cell-md-12">
                                <div class="range range-60">
                                    <div class="cell-lg-10">
                                        ...
                                        <input type="hidden" name="id_usuario_servicio" value="{{$postData->id_usuario_servicio}}"> @if(Session::has('idUsServ'))
                                        <input type="hidden" name="id_usuario_servicio" value="{{ Session::get('idUsServ') }}"> @endif
                                        ...
                                        <div class="form-wrap col-md-4">
                                            ...
                                            <br> @if($postData->status == 1)
                                            <input class="tooltip checkboxDays" type="checkbox" id='status' name="status" data-size="mini" data-on-color="success" data-on-text="Si" data-off-text="No" checked> @else
                                            <input class="tooltip checkboxDays" type="checkbox" id='status' name="status" data-size="mini" data-on-color="success" data-on-text="Si" data-off-text="No"> @endif
                                        </div>
                        ...
                        <div class="modal-content">
                            <div id="testboxForm" class="foto">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" aria-label="{{trans('front/responsive.cerrar')}}" onclick="loadImagesPost()">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <h4 style="text-align: center;color:#428bca;">
                                      {{trans('back/admin.descriptionAddImageModal')}}
                                    ...
                                    <input type="hidden" id="id_catalogo_fotografia" name="id_catalogo_fotografia" value="11"> @if(Session::has('idUsServ'))
                                    <input type="hidden" name="id_usuario_servicio" value="{{ Session::get('idUsServ') }}"> @else
                                    <input type="hidden" name="id_usuario_servicio" value="{{$postData->id_usuario_servicio}}"> @endif
                                ...
                                <div class="modal-footer">
                                    <a class="button button-facebook button-icon button-icon-sm button-icon-right fa-check" href="" data-dismiss="modal" id="nextbtn" onclick="loadImagesPost()">{{trans('front/responsive.finalizar')}}<span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            function loadImagesPost(){
              $('#spinnerLoadImagesAdmin').show();
              GetDataAjaxImagenesRes("{!!asset('/imagenesAjaxDescription1')!!}/11/{!!$postData->id!!}");
            }
            loadImagesPost();
            </script>
            <!-- @endif -->
