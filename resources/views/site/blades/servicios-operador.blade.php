      ...
      <section class="page-title breadcrumbs-elements page-title-inset-1">
        <div class="shell">
          <div class="page-title__overlay box-skew box-skew-var-1"><span class="box-skew__item"></span>
            <div class="page-title-text">{{$dataOperador->nombre_empresa_operador}}</div>
            <p class="big text-width-medium">El operador cuenta con los siguientes servicios :</p>
          </div>
        </div>
      </section>
            ...
            <div class="row">
              @if(count($findedServ) == 0)
                <div class="col-xs-12" style="text-align: center;">
                  <h4><a href="single-post.html"><i class="fa fa-frown-o "></i> &nbsp;&nbsp;Ups!! No se han encontrado servicios para este operador</a></h4>
                </div>
              @else
